...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xsyk-8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xsyk-8.containers.anotherwebservice.com/
...
```
git clone git@github.com:sandb0xn0d3/container-xsyk-8.git
cd container-xsyk-8
```
...
```
docker attach container-xsyk-8
```
